...
$customer_wallet_balance = (float) ( $customer_row['wallet_balance'] ?? 0 );
...
<?php require_once __DIR__ . '/components/customer/modal-tickets.php'; ?>
<?php require_once __DIR__ . '/components/customer/modal-ticket-detail.php'; ?>
