<!-- TOPBAR -->
  <div class="topbar">
    ...
    <div class="topbar-actions">
      ...
      <button class="topbar-btn" aria-label="Notifications" onclick="toggleNotif()" title="Notifications">
      ...
      <button class="topbar-btn disabled-action" aria-label="Export reports" title="Export reports are not connected yet" aria-disabled="true" onclick="showUnavailableFeature('Report export', 'Exports need a backend report endpoint before files can be generated.')">
