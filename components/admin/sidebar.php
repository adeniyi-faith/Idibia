...
<div class="sidebar" id="sidebar">
  ...
  <button class="nav-btn" onclick="nav('kyc',this)">
    ...
    KYC Queue <span class="nav-badge" id="kyc-badge" style="display:none"></span>
  </button>
  ...
  <button class="nav-btn" onclick="nav('reconciliation',this)">
  ...
  <button class="nav-btn" onclick="nav('wallet-topups',this)">
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg>
    Wallet Top-Ups <span class="nav-badge" id="topup-badge" style="display:none"></span>
  </button>
  ...
  <button class="nav-btn" onclick="nav('customers',this)">
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
    Customers
  </button>
  <button class="nav-btn" onclick="nav('disputes',this)">
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
    Disputes <span class="nav-warn-badge" id="dispute-badge" style="display:none"></span>
  </button>
  <button class="nav-btn" onclick="nav('ratings',this)">
  ...
  <button class="nav-btn" onclick="nav('campaigns',this)">
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 8h1a4 4 0 0 1 0 8h-1"/><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"/><line x1="6" y1="1" x2="6" y2="4"/><line x1="10" y1="1" x2="10" y2="4"/><line x1="14" y1="1" x2="14" y2="4"/></svg>
    Campaigns
  </button>
  <button class="nav-btn" onclick="nav('notifications',this)">
  ...
  <div class="sidebar-bottom">
    ...
    <button class="nav-btn" onclick="nav('audit-log',this)">
