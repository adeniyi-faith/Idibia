...
<div class="screen" id="screen-main">
  ...
  <div class="main-content">
    ...
    <div class="tab-view" id="tab-map">
      <div style="position:relative;display:flex;flex-direction:column;flex:1;overflow:hidden;min-height:0;">
        <div id="explore-map-container" style="flex:1;min-height:0;"></div>
        <div class="map-float" style="z-index:1000;">
