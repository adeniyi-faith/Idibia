<div class="modal" id="modal-sos">
  <div class="modal-content" style="max-width: 400px;">
    <div class="modal-header">
      <h3 style="color:var(--danger); display:flex; align-items:center; gap:8px; margin:0;">
      ...
      <button class="icon-btn" aria-label="Close modal" onclick="closeModal(null,'sos')">
    ...
    <div class="modal-body" style="padding: 20px;">
      <p style="font-size:13px; color:var(--text-muted); margin-bottom: 20px;">Please report any immediate safety concerns. High severity reports will alert our team immediately.</p>

      <div class="fi-input">
        <label>Category</label>
        <select id="sosCategory">
      ...
      <div class="fi-input">
        ...
        <textarea id="sosDescription" rows="4" placeholder="Tell us exactly what happened..."></textarea>
      </div>
