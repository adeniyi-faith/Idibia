  ...
  <div class="modal-content" onclick="event.stopPropagation()">
    ...
    <div class="receipt-box">
      ...
      <div class="receipt-payment">
        ...
        <button type="button" onclick="showUnavailableFeature('Receipt email', 'Receipt email delivery is not connected yet. Use the in-app payment status for now.')" style="margin-left:auto;background:none;border:none;font-size:12px;font-weight:700;color:var(--navy);cursor:pointer;text-decoration:underline;text-underline-offset:2px;padding:4px">Email Receipt</button>
      </div>
    </div>
    <!-- Star Rating -->
